    ...
    <div class="container py-10 sm:py-16">
      <div class="block sm:flex sm:gap-10">
        ...
        <div class="sm:w-3/4 flex flex-col md:items-start text-left">
          <h1 class="sm:text-3xl text-2xl mb-3 font-semibold dark:text-gray-50">Aangenaam!</h1>
          ...
          <p class="mb-3 leading-relaxed text-gray-500 dark:text-gray-400">In mijn portfolio neem ik websites en projecten op waar ik trots op ben en die ik graag met de buitenwereld deel! Wil je meer weten, dan kom ik graag in <router-link class="dark:text-gray-50 font-medium hover:underline" :to="{name: 'contact'}">contact</router-link>. Of bekijk mijn <a href="https://github.com/woutpeters" target="_blank" class="dark:text-gray-50 font-medium hover:underline">Github</a> pagina.</p>
        </div>
      </div>
    </div>
  </main>
