<template>
  ...
  <div class="h-96 w-full flex flex-wrap justify-center content-end md:content-center items-end md:items-center relative z-10">
    <div class="p-6 text-center ">
      <h2 class="text-xl lg:text-4xl font-bold">Sorry, de pagina die u zoekt kan niet worden gevonden</h2>
      <p class="mt-3 text-sm lg:text-base text-gray-900">We hebben ons best gedaan, maar het lijkt erop dat deze pagina niet (meer) bestaat of misschien verhuisd is.</p>
      <router-link class="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-medium px-5 py-2.5 rounded-lg inline-block shadow-2xl" :to="{name: 'home'}">Terug naar de homepage</router-link>
    </div>
  </div>
</template>
