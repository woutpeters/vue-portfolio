<template>
  <section class="bg-cool-gray-50 dark:bg-blue-gray-800">
    <div class="container flex flex-col sm:justify-between items-center sm:flex-row">
      <div class="w-full sm:w-1/3 text-left">
        <h1 class="text-3xl sm:text-4xl dark:text-gray-50 mb-3 text-center sm:text-left font-semibold">Hallo, ik ben Wout 👋</h1>
